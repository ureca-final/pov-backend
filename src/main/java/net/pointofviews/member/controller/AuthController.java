...
public class AuthController implements AuthSpecification{
    ...
    @Override
    @PostMapping("/signup")
    public ResponseEntity<BaseResponse<CreateMemberResponse>> signup(@Validated @RequestBody CreateMemberRequest request) {
    ...
    @Override
    @PostMapping("/login")
    public ResponseEntity<BaseResponse<LoginMemberResponse>> login(@Validated @RequestBody LoginMemberRequest request) {
